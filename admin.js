  ...
  database.ref("settings").on("value", (snapshot) => {
    if (snapshot.exists()) {
      ...
      document.getElementById("currentCode").value =
        settings.secret_code || "2245";
      document.getElementById("currentMaxClicks").value =
        settings.max_clicks || "3";
      document.getElementById("currentTimeLimit").value =
        settings.time_limit_minutes || "50000";
      ...
      const checkinStartTime = settings.checkin_start_time || "14:00";
      const checkinEndTime = settings.checkin_end_time || "22:00";
      ...
      const checkinTimeEnabled = settings.checkin_time_enabled;
